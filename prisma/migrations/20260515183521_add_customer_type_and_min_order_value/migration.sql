...
INSERT INTO "new_WholesaleCustomer" ("approvedAt", "approvedBy", "company", "createdAt", "discountPercent", "email", "firstName", "id", "lastName", "notes", "paymentTerms", "phone", "shopifyCustomerId", "status", "updatedAt") SELECT "approvedAt", "approvedBy", "company", "createdAt", "discountPercent", "email", "firstName", "id", "lastName", "notes", "paymentTerms", "phone", "shopifyCustomerId", "status", "updatedAt" FROM "WholesaleCustomer";
